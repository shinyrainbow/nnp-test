...
export const translations = {
  ...
  "calendar.calendarView.emptyMessage2": "This would show appointments in a monthly/weekly grid format",
    ...
    // "groups": {
      ...
      "groups.step1Description": "Add Facebook groups by name or ID to get started",
      ...
      "groups.step3Description": "Use bulk actions to select or deselect all groups",
      ...
      "groups.noGroupsDescription": "Add your first Facebook group to get started with posting.",
    ...
    // "scheduled": {
      ...
      "scheduled.noScheduledPostsDescription": "Your scheduled posts will appear here.",
    ...
    // "pagePost": {
      ...
      "pagePost.description": "Create and schedule posts directly to your Facebook page",
  ...
  "calendar.calendarView.emptyMessage2": "จะแสดงนัดหมายในรูปแบบตารางรายเดือน/รายสัปดาห์",
    ...
    // "groups": {
      ...
      "groups.step3Description": "ใช้การดำเนินการแบบกลุ่มเพื่อเลือกหรือยกเลิกการเลือกทั้งหมด",
      ...
      "groups.noGroupsDescription": "เพิ่มกลุ่มเฟซบุ๊กแรกของคุณเพื่อเริ่มต้นการโพสต์",
    ...
    // "scheduled": {
      ...
      "scheduled.noScheduledPostsDescription": "โพสต์ที่กำหนดการไว้ของคุณจะปรากฏที่นี่",
