        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className="text-gray-600 mt-2">Manage your rental agreements and tenant information</p>
            </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>A list of your rental contracts and their current status</CardDescription>
            </CardHeader>
            <CardContent>
